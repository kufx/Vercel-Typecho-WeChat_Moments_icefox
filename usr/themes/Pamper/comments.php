            ...
            <form method="post" action="<?php $this->commentUrl() ?>" id="comment-form" role="form" class="comment-form pt-7 links">
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <div class="w-full relative">
                        ...
                        <input type="url" name="url" id="url" class="shadow-lg transition w-full rounded text roundedaB border-1 border-solid p-2" placeholder="<?php _e('http://'); ?>"
                ...
                <div class="w-full relative">
                    ...
                    <textarea emoji="😺😸😹😻😼😽🙀😿😾🐵🙈🙉🙊💖💔💯💢👌✌️👍💪🤝🙏🧧🧨🎉👣😄😁😆🤣😂🙂🙃😍😘😋🤪🤭🤫🤔🤨😑😶😏🤕🤧😵🥳😎😕😟😯😳🥺😥😭😱😖😣😫🥱😡"style="margin-top: .5rem;max-height:100px;" rows="8" cols="50" name="text" id="textarea" class="roundedaB rounded w-full Comment_Textarea shadow-lg border-1 border-solid p-2 textarea" aria-required="true" onkeydown="if((event.ctrlKey||event.metaKey)&&event.keyCode==13){document.getElementById('submitComment').click();return false};" required><?php $this->remember('text'); ?></textarea>
                </div>
                ...
                <div class="flex gap-3 my-2">
                    ...
                    <button type="submit" id="submitComment" class="roundedaB shadow-lg w-full text-sm submit text-bbb p-2 font-medium rounded-lg btn py-4 px-6 border-1 border-solid "><?php _e('提交'); ?></button>
                </div>
            </form>
        </div>
    <?php else: ?>
